...
session_start();
$sel="SELECT * FROM tbl_appointment a INNER JOIN tbl_user u on a.user_id=u.user_id where doctor_id='".$_SESSION['did']."' and appointment_status=2";
 $row=$conn->query($sel);
 $i=0;
?>
...
<title>Appointment Reject List</title>
</head>
<body>
<a href="Homepage.php">
...
<table border="1" align="center">
 <tr>
    <td><a href="Acceptedappointment.php" ><button>Accepted List</button></a></td>
